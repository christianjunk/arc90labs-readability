...
var readability = {
	...
	getArticleTools: function () {
		...
		" + (readability.specialLinkOn ? readability.specialLink() : '');
//			<a href='#' onclick='readability.kindleBox(); return false;' title='Send to Amazon Kindle' id='kindle-page'>Send to Kindle</a>\

		return articleTools;
	},
	
    specialLink: function() {
    	return '<a href=\"https://donate.doctorswithoutborders.org/NETCOMMUNITY/SSLPage.aspx?pid=197&hbc=1\" target="_blank" title="Please Help Haiti" id="special-link">Please Help Haiti</a>';
    },
	...
	getArticleFooter: function () {
		...
		articleFooter.innerHTML = "\
			<a href='http://lab.arc90.com/experiments/readability'><img src='http://lab.arc90.com/experiments/readability/images/footer-readability.png" + statsQueryParams + "'></a>\
